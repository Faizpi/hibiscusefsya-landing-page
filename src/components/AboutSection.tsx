          ...
          <div className="flex-1">
            <ScrollReveal direction="left">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mt-3 mb-6 text-foreground">
                ...
                <span className="gradient-text">Hibiscus Efsya?</span>
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Sebagai bagian dari M.B.K Indonesia, kami membuka kesempatan kemitraan 
                franchise untuk berbagai unit bisnis kami. Bergabunglah dengan jaringan 
                bisnis yang sudah teruji dan raih kesuksesan bersama kami.
              </p>
            </ScrollReveal>
                ...
                <div className="relative">
                  ...
                  <div className="glass-card-red p-8 relative z-10">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">part of M.B.K Indonesia</p>
                      ...
                      <div className="mt-6 pt-6 border-t border-border">
                        <div className="grid grid-cols-3 gap-4 text-center">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">Unit Bisnis</div>
                          </div>
                          <div>
